...
public class EnIdAdapter extends RecyclerView.Adapter<EnIdAdapter.KamusHolder> {

    private ArrayList<EnIdModel> mData = new ArrayList<>();
    ...
    public void addItem(ArrayList<EnIdModel> mData){
        this.mData = mData;
